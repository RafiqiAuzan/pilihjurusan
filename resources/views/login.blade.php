...
<body class="body-bg min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0">
        ...
        <section class="mt-10">
            <form class="flex flex-col" method="POST" action="#">
                ...
                <div class="flex justify-end">
                    <a href="#" class="text-sm text-purple-600 hover:text-purple-700 hover:underline mb-6">Forgot
                        your password?</a>
                </div>
                <button
    ...
    <div class="max-w-lg mx-auto text-center mt-12 mb-6">
        <p class="text-white">Don't have an account? <a href="#" class="font-bold hover:underline">Sign up</a>.
        </p>
    </div>
