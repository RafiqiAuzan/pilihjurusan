<x-layouts.full-rows title="Aplikasi Tes Psikologi Terbaik" class="bg-[#F9F7EA]">
    ...
    <section id="aktivitas " class="w-full h-full ">
        <div class="mx-auto">
            ...
            <div class="flex flex-cols justify-center gap-6 mt-7">
            ...
            <div class="grid grid-cols-1 gap-3 px-4 pt-5 pb-10 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                <div class="mt-5 overflow-hidden shadow-lg rounded-xl bg-light-100">
                 <div class="relative h-[200px]">
                    ...
                    <div class="p-5">
                        ...
                        <i class="pr-2 bi bi-calendar-week"></i> 20 Oktober - 31 Oktober 2022
                        <i class="pr-2 bi bi-pin-map-fill"></i> Online
                        <x-atoms.button href="#" size="sm" status="solid" class="mt-5 bg-light-100 border-transparent text-primary-500">
                            Lebih lanjut..
                        </x-atoms.button>
                    </div>
                </div>
                <div class="mt-5 overflow-hidden rounded-lg shadow-lg bg-light-100">
                    ...
                    <div class="p-5">
                        ...
                        <i class="pr-2 bi bi-person-fill"></i> Pilih jurusan
                        <br>
                        <i class="bi bi-hdd-stack pr-2"></i> Education
                        <x-atoms.button size="sm" status="solid" class="mt-3">
                            Lebih lanjut..
                        </x-atoms.button>
                    </div>
                </div>
                <div class="mt-5 overflow-hidden rounded-lg shadow-lg bg-light-100">
                    ...
                    <div class="p-5">
                        ...
                        <i class="pr-2 bi bi-calendar-week"></i> 20 Oktober - 31 Oktober 2022
                        <i class="pr-2 bi bi-pin-map-fill"></i> Online
                        <x-atoms.button size="sm" status="solid" class="mt-5">
                            Lebih lanjut..
                        </x-atoms.button>
                    </div>
                </div>
                <div class="mt-5 overflow-hidden rounded-lg shadow-lg bg-light-100">
                    ...
                    <div class="p-5">
                        ...
                        <i class="pr-2 bi bi-calendar-week"></i> 20 Oktober - 31 Oktober 2022
                        <i class="pr-2 bi bi-pin-map-fill"></i> Online
                        <x-atoms.button size="sm" status="solid" class="my-4 bg-light-100 border-transparent text-primary-500">
                            Lebih lanjut..
                        </x-atoms.button>
                    </div>
                </div>
