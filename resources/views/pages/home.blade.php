            ...
            <div class="container px-10 py-10 mx-auto">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-5 lg:pr-20">
                    ...
                    <div class="text-light-100">
                        ...
                        <ul class="flex">
                            <a href="https://www.facebook.com/pilihjurusan.id/?_rdc=1&_rdr">
                                <li><i class="px-2 bi-facebook hover:text-secondary-500"></i></li>
                            </a>
                            <a href="https://www.tiktok.com/@pilihjurusan.id/?">
                                <li><i class="px-2 bi-tiktok hover:text-secondary-500"></i></li>
                            </a>
                            <a href="https://www.instagram.com/pilihjurusan.id/">
                                <li><i class="px-2 bi-instagram hover:text-secondary-500 "></i></li>
                            </a>
                            <a href="https://twitter.com/pilihjurusan_id">
                                <li><i class="px-2 bi-twitter hover:text-secondary-500"></i></li>
                            </a>
                            <a href="https://www.youtube.com/channel/UCCYChKuM_xasaGUR874GTfg?themeRefresh=1">
                                <li><i class="px-2 bi-youtube hover:text-secondary-500"></i></li>
                            </a>
                            <a href="https://www.linkedin.com/company/pilihjurusan/">
                                <li><i class="px-2 bi-linkedin hover:text-secondary-500"></i></li>
                            </a>
                        </ul>
                    </div>
                </div>
