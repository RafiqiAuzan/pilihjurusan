...
{{-- Section Message --}}
    <section>
        <div class="flex flex-col justify-center items-center py-32 gap-12
        bg-[#F9F7EA]" px="100px">
            <div class="flex flex-col items-center max-w-5xl" height="681px">
                <div class="flex flex-col items-center justify-center max-w-5xl gap-12" height="681px">
                    <div class="flex flex-col items-center max-w-5xl gap-6" height="93px">
                        <p class="max-w-5xl h-11 font-display not-italic font-bold text-4xl text-center text-[#262829]">
                            Seperti apa sistem Bimbingannya?
                        </p>
                        <p class="max-w-5xl h-11 font-body not-italic font-normal text-base text-center text-[#6D6C63]">
                            sistem bimbingan insentif akan sangat membantu
                        </p>
                    </div>
                    <div class="flex flex-col items-start max-w-5xl gap-5" height="540px">
                        <div class="flex flex-col items-center justify-center max-w-5xl isolate" height="540px">
    ...
    {{-- Section activities --}}
     <section id="aktivitas " class="">
        <div class="mx-auto w-full h-full bg-[#F9F7EA]">
            ...
            <div class="container mx-auto">
                <div class="flex justify-center gap-3 flex-cols mt-7 sm:px-4">
...
{{-- Section testimoni --}}
    ...
    <div class="w-full h-full bg-[#FAF9F7] flex items-center justify-between">
        <div class="self-start px-10 py-16 mx-auto text-left lg:text-center">
            <div class="mt-32">
                <h1 class="pb-5 text-4xl font-bold text-base-800">Pilihjurusan Disukai Banyak Orang loh!</h1>
              </div>
