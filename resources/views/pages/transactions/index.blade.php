        ...
        <div class="space-y-8">
            ...
            <div class="flex flex-col gap-8 lg:flex-row">
                ...
                <div class="px-8 py-5 lg:w-[640px] rounded-xl bg-light-100">
                    ...
                    {{-- Images --}}
                    {{-- <img class="w-28 lg:w-full hidden lg:block rounded-3xl aspect-square" src="{{ asset('img/global/stonipe.png') }}"
                            alt="Frame"> --}}
            ...
            <div class="space-y-4 pt-4">
                <x-atoms.button tag="a" href="transaction2" class="w-full text-center">Selanjutnya
                </x-atoms.button>
