                   ...
                   <div class="border border-light-400 p-4 rounded-2xl mt-8">
                    ...
                    {{-- Pagination --}}
                     <div class="flex justify-center lg:justify-end py-4">
                        ...
                        <a href="#" class=" px-4 py-2 mx-1 text-gray-700 transition-colors duration-300 transform bg-base-200 rounded-md sm:inline ">
                            1
                        </a>
                        ...
                        <a href="#" class=" hidden px-4 py-2 mx-1 text-gray-700 transition-colors duration-300 transform bg-base-200 rounded-md sm:inline ">
                            4
                        </a>
                        ...
                        <a href="#" class="flex items-center justify-center px-4 py-2 mx-1 text-gray-700 transition-colors duration-300 transform bg-base-200 rounded-md rtl:-scale-x-100 ">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
