    ...
    <section class="pt-8">
        <div class="space-y-8" x-data="{ 'exitConfirmation': false }" @keydown.escape="exitConfirmation = false">
            ...
            <div action="" class="w-full p-8 space-y-8 rounded-3xl bg-light-100 h-fit" x-data="{ 'Confirmation': false }" @keydown.escape="Confirmation = false">
                ...
                <div class="bg-light-300 rounded-2xl py-[120px] mx-[480px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-image-alt mx-auto" viewBox="0 0 16 16">
