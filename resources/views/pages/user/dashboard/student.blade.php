    ...
    <section class="bg-light-200 pb-1">
        <div class="container mx-auto">
            ...
            {{-- <form class="bg-light-100 p-8 rounded-3xl mb-10">
                <h1 class="text-center lg:text-left font-display font-bold text-[36px] mb-7">Dapat Dibeli</h1>
                <div class="grid grid-cols-1 lg:grid-cols-5 md:grid-cols-3 gap-6">
                    <div class="flex flex-row">
                        <div class="flex flex-col mx-auto lg:ml-auto border border-solid p-3 gap-3 rounded-3xl bg-light-100 border-light-400">
            ...
            <form class="bg-light-100 p-8 rounded-3xl mb-10">
                <h1 class="text-center lg:text-left font-display font-bold text-[36px] mb-7 lg:ml-4">Layanan Tersedia</h1>
                <div class="grid grid-cols-2 lg:grid-cols-4 md:grid-cols-3 gap-6">
                    <div class="flex flex-row mx-auto">
