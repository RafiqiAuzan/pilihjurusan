...
<head>
    ...
    <style @nonce>
        ...
        body {
            background-image: url('/storage/images/header.png');
        }
    </style>
</head>

<body class="leading-normal tracking-normal text-piljur-primary m-6 bg-cover bg-fixed">
    <div class="h-full">
        <!--Nav-->
        <div class="w-full container mx-auto">
            <div class="w-full flex items-center justify-between">
                <a class="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
                    href="#">
                    Rain<span
                        class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500">blur</span>
                </a>
        ...
        <div class="container pt-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
                <h1
                    class="my-4 text-3xl md:text-5xl text-sky-500 opacity-75 font-bold leading-tight text-center md:text-left">
                    Main
                    <span
            ...
            <div class="w-full xl:w-3/5 p-12 overflow-hidden">
                <img class="mx-auto w-full md:w-4/5 transform -rotate-6 transition hover:scale-105 duration-700 ease-in-out hover:rotate-6"
                    src="{{ asset('storage/svg/macbook.svg') }}" />
            </div>
            ...
            <div class="mx-auto md:pt-16">
                ...
                <div class="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
                    <img src="{{ asset('storage/svg/App Store.svg') }}"
                        class="h-12 pr-12 transform hover:scale-125 duration-300 ease-in-out" />
                    <img src="{{ asset('storage/svg/Play Store.svg') }}"
