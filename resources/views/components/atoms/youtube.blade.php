<div class="container flex flex-col items-center justify-center mx-auto isolate">
    <iframe class="z-0 rounded-[36px] lg:w-[1024px] lg:h-[540px] sm:w-[372px] h-[200px]" src="{{ $src }}"
        id="youtube" title="YouTube video player" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
    </iframe>
    <button id="playbtn"
        class="playbtn z-1 rounded-[42px] flex flex-col justify-center items-center
